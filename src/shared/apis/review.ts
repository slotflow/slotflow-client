...
export const createReview = async (data: CreateReviewRequest): Promise<ApiBaseResponse<void>> => {
    const response = await axiosInstance.post('/reviews', data);
    return response.data;
}

export const fetchReviews: ApiFetchFunction<
...
export const deleteReview = async (reviewId: Review["_id"]): Promise<ApiBaseResponse<void>> => {
    const response = await axiosInstance.delete(`/reviews/${reviewId}/block`);
    return response.data;
}

export const toggleReviewBlockStatus = async (payload: ToggleReviewBlockStatusRequest): Promise<ApiBaseResponse<void>> => {
...
export const reportReview = async (reviewId: Review["_id"]): Promise<ApiBaseResponse<void>> => {
