...
export const signup = createAsyncThunk<ApiBaseResponse<void>, SignupRequest>('auth/signup',
...
export const verifyOtp = createAsyncThunk<ApiBaseResponse<void>, VerifyOtpRequest>("auth/verify-otp",
...
export const resendOtp = createAsyncThunk<ApiBaseResponse<void>>("auth/resendOtp",
    async () => {
...
export const signout = createAsyncThunk<ApiBaseResponse<void>>("auth/signOut",
    async () => {
...
export const verifyEmail = createAsyncThunk<ApiBaseResponse<void>, VerifyEmailRequest>("auth/verifyEmail",
...
export const updatePassword = createAsyncThunk<ApiBaseResponse<void>, UpdatePasswordRequest>("auth/updatePassword",
