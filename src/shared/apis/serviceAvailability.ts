...
export const fetchEngagedSlots = async (data: FetchEngagedSlotsRequest): Promise<ApiBaseResponse<FetchEngagedSlotsResponse>> => {
...
export const fetchServiceAvailabilityByProviderId = async ({ date, providerId }: FetchServiceAvailabilityRequest): Promise<ApiBaseResponse<FetchServiceAvailabilityResponse>> => {
