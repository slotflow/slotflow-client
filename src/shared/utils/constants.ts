...
export const PlanList: PlanListType = [
  {
    ...
    description:
      'Perfect for individuals or freelancers getting started with appointment scheduling.',
    features: [
  ...
  },
  {
    ...
    description:
      'Ideal for solo professionals looking for a branded experience and better control.',
    features: [
  ...
  },
  {
    ...
    description:
      'Designed for growing teams or businesses that require advanced scheduling and integrations.',
    features: [
  ...
  },
  {
    ...
    description:
      'Best suited for organizations that need scalable, secure, and fully customizable scheduling solutions.',
    features: [
