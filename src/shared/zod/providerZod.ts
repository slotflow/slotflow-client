...
export type ProviderCreateServiceDetailsFormType = z.infer<
  typeof providerCreateServiceDetailsZodSchema
>;
...
export type ProviderServiceAvailabilityFormType = z.infer<
  typeof providerServiceAvailabilityZodSchema
>;
