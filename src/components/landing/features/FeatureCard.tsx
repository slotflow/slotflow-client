...
const FeatureCard = ({ title, description, className, children }: FeatureCardProps) => {
  return (
    <div
      className={cn(
        `group relative overflow-hidden rounded-3xl border border-primary/60 bg-background/70 p-5 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-primary/60 hover:shadow-[0_30px_80px_rgba(0,0,0,0.12)]`,
        className,
      )}
    >
