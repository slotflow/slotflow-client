...
const FeaturesHeader = () => {
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      >
        Discover providers, compare availability, schedule appointments, make secure payments, and
        manage every booking from one modern platform designed for customers and service
        professionals.
      </SplitTextReveal>
    </div>
  );
