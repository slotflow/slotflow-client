...
const LiveChatBubble = ({ onClick }: LiveChatBubbleProps) => {
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex items-center">
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onClick}
          className="relative flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-background/70 shadow-2xl backdrop-blur-2xl"
        >
