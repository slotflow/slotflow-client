      ...
      <Card className="max-w-7xl mx-auto overflow-hidden rounded-[40px] border bg-gradient-to-br from-primary/10 via-background to-primary/5">
        <CardContent className="px-10 py-20 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
            Join thousands of business owners receiving practical guides, product updates, AI
            scheduling insights, and growth strategies.
          </p>
          ...
          <p className="mt-5 text-sm text-muted-foreground">No spam. Unsubscribe anytime.</p>
        </CardContent>
      </Card>
    </section>
  );
