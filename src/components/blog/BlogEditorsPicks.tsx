...
const BlogEditorsPicks = ({ handPickedArticles }: BlogEditorsPicksProps) => {
  ...
  return (
    <section id="editors-picks" className="px-6 py-24">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          <div>
            <Badge variant="outline">Editor's Picks</Badge>
            <h2 className="mt-4 text-4xl font-bold">Handpicked Reads</h2>
            <p className="mt-4 max-w-2xl text-muted-foreground">
              Our favorite articles to help appointment-based businesses improve efficiency, delight
              ...
              <div className="flex flex-col gap-6 p-8 md:flex-row md:items-center">
                ...
                <div className="flex-1">
                  ...
                  <h3>
                    <Link
                      to={`/blog/${article.id}`}
                      className="hover:underline mt-3 text-2xl font-bold transition group-hover:text-primary"
                    >
                      {article.heroTitle}
                    </Link>
                  </h3>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Button variant="ghost" onClick={() => navigate(`/blog/${article.id}`)}>
                    Read →
                  </Button>
                </div>
              </div>
