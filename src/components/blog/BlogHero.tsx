...
const BlogHero = ({
  ...
  const featuredDescription =
    ...
    'Fresh articles and practical strategies for growing your business.';
    ...
    <section id="hero" className="relative overflow-hidden w-full">
      <div className="relative px-6 py-24 max-w-7xl mx-auto">
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          ...
          >
            <SplitTextReveal as="h1" className="text-5xl font-black leading-tight lg:text-7xl">
              Learn.
              <br />
              Grow.
              <br />
            ...
            <p className="mt-8 max-w-xl text-lg text-muted-foreground leading-8">
              Discover practical guides, growth strategies, product updates, and expert insights to
              help appointment-based businesses improve efficiency, reduce no-shows, and delight
              customers.
            </p>
          ...
          >
            <Card className="overflow-hidden rounded-3xl border shadow-xl">
              ...
              <div className="space-y-4 p-8">
                ...
                <h2 className="text-3xl font-bold leading-tight">{featuredTitle}</h2>
