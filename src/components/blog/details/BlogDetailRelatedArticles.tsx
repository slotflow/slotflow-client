...
const BlogDetailRelatedArticles = ({ relatedArticles }: BlogDetailRelatedArticlesProps) => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-bold">Related Articles</h2>
          </div>
        </div>
          ...
          {relatedArticles.map((article) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <p className="mt-4 leading-7 text-muted-foreground">{article.heroDescription}</p>
              </CardContent>
            </Card>
          ))}
        </div>
