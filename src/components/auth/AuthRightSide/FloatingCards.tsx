...
const FloatingCards = () => {
  return (
    <div className="relative mx-auto mt-20 h-[430px] w-full max-w-5xl">
      <MoveAnything direction="left" delay={0.2} duration={7} className="absolute left-8 top-0">
        <NotificationCard />
      </MoveAnything>

      <MoveAnything direction="right" delay={0.5} duration={8} className="absolute right-8 top-8">
        <PaymentCard />
      </MoveAnything>
      ...
      <MoveAnything direction="left" delay={1.1} duration={9} className="absolute bottom-4 left-16">
        <ChatCard />
      </MoveAnything>
