...
const ProviderServiceAvailabilityForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <h4 className="text-xl lg:text-2xl font-semibold text-start">
                {authUser?.isServiceAvailabilityAdded ? "Update your availability" : "Set your availability"}
            </h4>
            ...
            <CreateServiceAvailabilityFooter
                ...
                isValid={isValid}
                isUpdating={authUser?.isServiceAvailabilityAdded ?? false}
            />
        </form>
    )
}
