...
const ProfileListing = ({
  ...
  useEffect(() => {
    ...
    if (
      (userLookingProvider || adminLookingProvider || adminLookingUser) &&
      'username' in data &&
      setSelectedUserData
    ) {
      setSelectedUserData({
  ...
  if (adminLookingProvider) {
    ...
    fields = [
      ...
      {
        label: 'Slotflow Trusted',
        value: getBooleanStatusComponent(d.trustedBySlotflow, STATUS_PRESETS.trustStatus),
        Icon: BadgeCheck,
      },
      {
        label: 'Admin Verified',
        value: getBooleanStatusComponent(d.isAdminVerified, STATUS_PRESETS.verificationStatus),
        Icon: BadgeCheck,
      },
      {
        label: 'Address Verified',
        value: getBooleanStatusComponent(d.isAddressVerified, STATUS_PRESETS.verificationStatus),
        Icon: MapPin,
      },
      {
        label: 'Service Details Verified',
      ...
      },
      {
        ...
        value: getBooleanStatusComponent(d.isProofsVerified, STATUS_PRESETS.verificationStatus),
        Icon: BadgeCheck,
      },
