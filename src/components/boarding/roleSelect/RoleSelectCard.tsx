...
const RoleSelectCard = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 dark:from-indigo-500/10 dark:to-violet-500/10 opacity-0 transition-opacity duration-500 ${
      ...
      <div className="relative flex h-full flex-col">
        <div className="mx-auto mb-8">
          <div
            className={`flex h-24 w-24 items-center justify-center rounded-3xl shadow-lg transition-transform duration-300 ${
              isSelected
