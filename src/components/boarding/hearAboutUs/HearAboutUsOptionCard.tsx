      ...
      {hearAboutUsOptions.map((option) => {
        ...
        return (
          <Card
            ...
            className={`group relative overflow-hidden cursor-pointer rounded-2xl border p-5 backdrop-blur-xl transition-all duration-300 bg-white/70 dark:bg-neutral-900/70 ${
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 dark:from-indigo-500/10 dark:to-violet-500/10 opacity-0 transition-opacity duration-500 ${selectedOption === option.value ? 'opacity-100' : 'group-hover:opacity-100'}`}
            />
