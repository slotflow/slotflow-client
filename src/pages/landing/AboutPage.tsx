        ...
        <section id="mission" className="w-full">
          <div className="mx-auto mt-28 grid max-w-7xl items-center gap-16 lg:grid-cols-2">
            <div className="dark:text-white">
              <h2 className="text-3xl font-bold relative">Our Mission</h2>

              <p className="mt-6 leading-8 relative">
                We believe scheduling should never become a barrier between businesses and their
                customers. Our mission is to remove complexity, reduce manual work, and create
                booking experiences that feel fast, intuitive, and dependable.
              </p>

              <p className="mt-6 leading-8 relative">
                Whether you're an independent consultant, a healthcare provider, or a growing
                organization, Slotflow gives you the tools to manage appointments with confidence.
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {companyValues.map((value) => (
                ...
                >
                  ...
                  <p className="text-xl font-bold relative z-20 mt-2">{value.title}</p>

                  <p className="mt-4 relative z-20 text-sm">{value.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="stats" className="w-full">
          <div className="grid gap-10 text-center md:grid-cols-3 mt-20 p-10 border relative bg-background">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Possibilities to Grow</p>
            </div>
          </div>
        </section>
      </CardSpotlight>
