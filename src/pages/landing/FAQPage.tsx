...
const FAQPage = () => {
  ...
  const filteredFaqs = useMemo(() => {
    ...
    return faqs.filter(
      (faq) =>
        faq.question.toLowerCase().includes(query) || faq.value.toLowerCase().includes(query),
    );
  }, [faqs, searchText]);
  ...
  return (
    <main className="min-h-screen w-full">
      ...
      <MoveUpward>
        <FAQPageSearch value={searchText} onChange={setSearchText} />
      </MoveUpward>
      <FAQAccordion faqs={filteredFaqs} loading={faqLoading} />
