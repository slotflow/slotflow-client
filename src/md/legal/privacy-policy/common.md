...
This Privacy Policy explains how we collect, use, disclose, store, protect, and otherwise process your personal information when you access or use our services, whether you are a **User** seeking appointments or services, or a **Provider** offering services through the SlotFlow platform.
...
By accessing or using SlotFlow, you acknowledge that you have read and understood this Privacy Policy. Where required by applicable law, we will request your consent before collecting or processing certain categories of personal information.

Some features of our platform rely on trusted third-party service providers, such as payment processors, authentication providers, cloud infrastructure providers, analytics services, communication platforms, and other technology partners. These third-party services may process your information in accordance with their own privacy policies. We encourage you to review their privacy practices where applicable.
...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| Creating and managing user or provider accounts                                              | Performance of a Contract                          |
| Provider onboarding and verification                                                         | Performance of a Contract                          |
| Appointment booking and management                                                           | Performance of a Contract                          |
| Communication between Users and Providers                                                    | Performance of a Contract                          |
| Processing payments and subscriptions                                                        | Performance of a Contract                          |
| Providing customer support                                                                   | Performance of a Contract and Legitimate Interests |
| Operating AI-powered assistance                                                              | Performance of a Contract and Legitimate Interests |
| Personalizing platform features                                                              | Legitimate Interests                               |
| Analytics and service improvement                                                            | Legitimate Interests                               |
| Platform security and monitoring                                                             | Legitimate Interests                               |
| Fraud detection and prevention                                                               | Legitimate Interests                               |
| Maintaining system logs and diagnostics                                                      | Legitimate Interests                               |
| Compliance with applicable laws, legal requests, and regulatory obligations                  | Legal Obligation                                   |
| Managing cookies that are strictly necessary for platform operation                          | Legitimate Interests or Performance of a Contract  |
| Non-essential cookies, analytics cookies, and similar technologies where consent is required | Consent                                            |
| Marketing emails, newsletters, and promotional communications                                | Consent                                            |
| Processing where you have expressly agreed to a specific activity                            | Consent                                            |

Where we rely on your consent, you may withdraw it at any time. Withdrawal of consent will not affect the lawfulness of processing carried out before the withdrawal.

Where we rely on our legitimate interests, we balance those interests against your rights and freedoms and process personal information only where those interests are not overridden by your fundamental rights.
...
Where applicable law distinguishes between the "sale" and "sharing" of personal information, SlotFlow does not sell personal information for monetary consideration. We also do not share personal information for cross-context behavioral advertising or targeted advertising purposes.
...
**Email:** [legal@slotflow.in](mailto:legal@slotflow.in)

When submitting a request, please provide sufficient information to help us verify your identity and process your request. We may request additional information where reasonably necessary to protect your personal information and prevent unauthorized access.

We will acknowledge and respond to eligible privacy requests within a reasonable period and, where applicable law requires, generally within **30 days** of receiving a verifiable request. If additional time is required due to the complexity or volume of requests, we will notify you as permitted by applicable law.
...
Our security program is designed to safeguard personal information while supporting the secure operation of the SlotFlow platform.
...
If we become aware of a security incident or personal data breach that is likely to result in a risk to affected individuals, we will investigate the incident, take appropriate remedial measures, and provide notifications to affected individuals and competent authorities where required by applicable law.
...
If we become aware that an account has been created in violation of our minimum age requirements or that personal information has been collected from a child without the necessary authorization, we will take reasonable steps to verify the circumstances, deactivate the account where appropriate, and delete the associated personal information unless we are required or permitted by applicable law to retain certain information.
